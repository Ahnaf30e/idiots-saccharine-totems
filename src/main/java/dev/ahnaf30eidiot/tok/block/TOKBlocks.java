...
public class TOKBlocks {
    ...
    public static final Block FERROUS_METAL_BLOCK = registerBlock("ferrous_metal_block", new Block(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_WHITE).strength(48.0F, 1900.0F).requiresTool().sounds(BlockSoundGroup.NETHERITE).velocityMultiplier(1.0F).slipperiness(1.02041F))); // Perfect slipperiness for items
