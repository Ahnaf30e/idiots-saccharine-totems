...
public class TOKEffects {
    ...
    public static final RegistryEntry<StatusEffect> FERROUS = registerStatusEffect("ferrous", new FerrousEffect(StatusEffectCategory.BENEFICIAL, 0xbab1b5).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, Identifier.of(IdiotsSaccharineTotems.MOD_ID, "ferrous"), -0.20f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
